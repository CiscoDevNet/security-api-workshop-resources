'''
    This is an example of solution for the enrich.py file, that returns verdict and judgement to SecureX
'''
...
def build_input_api(observables):
    # formating and cleanup of obervables before sending them to the third party
...
def call_api(value,api_key):
    # Send API Call to the  Umbrella Investigatethird-party
    headers = {
...
def deliberate_observables():
    ...
    g.judgements = [] # Let's create a list into which we will store valid judgements data results for every observables
    ...
    for observable in observables:
        ...
        g.judgements.append(get_judgement(o_value, o_type, disposition_tuple, valid_time))
